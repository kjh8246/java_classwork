...
public class Member {
	...
	boolean isAdopt(Animal animal) {	//Animal 자식클래스 Puppy,Cat,Rabbit 객체가 animal변수로 참조하게 된다.
		//현재 회원객체가 인자로 전달받은  animal 객체의 분양자격이 되는지 반환값 결정한다.
		//instanceof 연산 : 구체화된 객체타입을 겁사한다. 자식클래스 객체들에게 사용하는 연산.
