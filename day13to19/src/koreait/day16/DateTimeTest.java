...
public class DateTimeTest {
	//날짜와 시간형식을 다루는 자바클래스를 연습힙니다.
	//1)java.util.Date 클래스 2)java.util.Calendar클래스
	//3)java 8버전 LocalDate(날짜) , LocalTime(시간) , LocalDateTime(날짜와 시간) 클래스
	public static void main(String[] args) {
		...
		LocalDate mybirth = LocalDate.of(2003, 12, 7);
		...
		day=30;
		System.out.println("오늘 날짜-"+day+"일전 은 "+currentDate.minusDays(day));
		...
		//ChronoUnit   :  시,분,초,년,월,주,일 단위 메소드가 있다.
