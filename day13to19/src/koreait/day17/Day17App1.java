...
//		mac1=mac2;		//down casting(자식타입으로 참조) - 강체 캐스팅 필요
...
//		MacBook mb = rc;			//down casting - 강제 캐스팅 필요
		...
		WebSearch mac4 = new MacBook();			//다연의 맥북
...
//		mac4.setVolume(13);   // 오류의 원인 : mac4의 참조타입 RemoteControl은 setVolum메소드 없습니다.
		mac4.search("유툽");
...
//		필요하다면 casting으로 메소드를 실행합니다.
		...
		//다현의 맥북을 가리키는 변수는 mac4,temp,web 이고 모두 같은값입니다.
