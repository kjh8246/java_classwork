...
// 생성자 메소드 연습힙니다.(리턴값은 없고, 인자는 있을수도 있는 메소드)- constructor
//		-> 생성자 메소드 실행으로 객체가 만들어 진다.
// 		-> 기본생성자 : 인자가 없는 형식의 생성자
// 		-> 커스텀생성자 : 필드값 초기화를 위해서 인자가 있는 형식의 생성자
	int f1;		//default 접근권한			//필드값
	String f2;
	double[] f3;
	public String f4;	//public 접근권한
	
	public MyClass1() {
		// 커스텀생성자를 정의하면 기본생성자를 생략을 할 수 없습니다.-> 필요하다면 기본생성자 정의가 필요함
		// -> 객체 생성할 때 new MyClass1() 허용하지 않겠다면 , 기본생성자 정의 12번 라인 쓰지 않는다.
	}
